...
const FORMATS = {
  savunma: [
    '## Yönetici Özeti',
    '## Durum ve Tehdit Değerlendirmesi',
    '## Risk Matrisi',
    '## Erken Uyarı Göstergeleri',
    '## Komuta Kontrol Öncelikleri',
    '## Acil Eylem Planı',
    '## Belirsizlikler ve Takip İhtiyaçları',
    '## Sonuç',
  ],
  enerji: [
    '## Yönetici Özeti',
    '## Altyapı ve Arz Güvenliği Durumu',
  ...
  saldiri: [
    '## Yönetici Özeti',
    '## Olay / Kapasite Değerlendirmesi',
    '## Caydırıcılık ve Eskalasyon Riski',
    '## Kritik Zafiyetler',
  ...
  toplumsal: [
    ...
    '## Toplumsal Gerilim Dinamikleri',
    '## Nefret Söylemi ve Ayrımcılık Riski',
    '## Kamu Düzeni ve Güvenlik Riski',
    '## Yerel Yönetim ve Kolluk Değerlendirmesi',
    '## İletişim ve Önleyici Politika Önerileri',
  ...
  btk: [
    '## Yönetici Özeti',
    '## Telekom / Ağ Olayı Özeti',
    '## Anomali ve Dolandırıcılık Göstergeleri',
    '## Teknik Riskler',
    '## Müdahale Önerileri',
    '## Sonuç',
  ],
